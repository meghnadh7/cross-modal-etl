...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--device", default=None, help="Computation device, e.g. cuda:0 or cpu")
    parser.add_argument("--batch-size", type=int, default=32, help="Batch size for all encoders")
    parser.add_argument("--num-workers", type=int, default=2, help="DataLoader workers")
    parser.add_argument("--skip-invalid", action="store_true", help="Skip corrupted/low-quality samples")
...
def main() -> None:
    ...
    from cross_modal.embeddings import CLAPEmbeddingEngine, CLIPEmbeddingEngine
    ...
    if args.image_dir and args.coco_annotations:
        visual_dataset = VisualDataset(args.image_dir, args.coco_annotations, image_size=args.image_size)
    ...
    print(f"Embeddings written to: {output_dir}")
